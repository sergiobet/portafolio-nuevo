              ...
              <form ref={form} onSubmit={sendEmail}>
                <div className="mb-6">
                  <input
                    ...
                    required
                  />
                  <span className="mt-2 hidden text-sm">
                ...
                {alertVisible && (
                  <div
                    ...
                    className="flex items-center p-4 mb-4 text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 justify-between"
                    role="alert"
                  >
